...
(this, (function () {
        ...
        function ie(t, e, i, s, n, o = {}) {
            ...
            for (t.save(), t.font = n.string, function (t, e) {
                ...
                h = a[l], r && (o.strokeColor && (t.strokeStyle = o.strokeColor), $(o.strokeWidth) || (t.lineWidth = o.strokeWidth), t.strokeText(h, i, s, o.maxWidth)), t.fillText(h, i, s, o.maxWidth), se(t, i, s, h, o), s += n.lineHeight;
            t.restore()
        }
        ...
        function yi(t, e = "x") {
            ...
            !function (t, e, i) {
                ...
                h = xi(t, 0);
                for (let c = 0; c < s - 1; ++c)
                    l = h, h = xi(t, c + 1), l && h && (Tt(e[c], 0, mi) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c])))
            }
            (t, n, o),
            function (t, e, i = "x") {
                const s = bi(i),
        ...
        function wi(t, e, i, s, n) {
            ...
            e.capBezierPoints && function (t, e) {
                ...
                r = Zt(t[0], e);
                for (i = 0, s = t.length; i < s; ++i)
                    a = o, o = r, r = i < s - 1 && Zt(t[i + 1], e), o && (n = t[i], a && (n.cp1x = vi(n.cp1x, e.left, e.right), n.cp1y = vi(n.cp1y, e.top, e.bottom)), r && (n.cp2x = vi(n.cp2x, e.left, e.right), n.cp2y = vi(n.cp2y, e.top, e.bottom)))
            }
            (t, i)
        }
        const Mi = t => 0 === t || 1 === t,
        ...
        function Ti(t, e, i) {
            return function (t, e) {
                ...
                let s = Ai.get(i);
                return s || (s = new Intl.NumberFormat(t, e), Ai.set(i, s)),
                s
            }
            (e, i).format(t)
        }
        ...
        function Fi(t, e, i) {
            ...
            for (let t = c, i = c; t <= d; ++t)
                m = e[t % a], m.skip || (p = h(m[s]), p !== x && (b = l(p, n, o), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(zi({
                                    start: _,
                                    end: t,
                                    loop: u,
                                    count: a,
        ...
        class ks {
            ...
            _resolveElementOptions(t, e = "default", i) {
                ...
                return f.$shared && (f.$shared = r, n[o] = Object.freeze(Ms(f, r))),
                f
            }
        ...
        class zs extends Ss {
            ...
            calculateLabelRotation() {
                ...
                c + 6 > o && (o = u / (i - (t.offset ? .5 : 1)), a = this.maxHeight - Rs(t.grid) - e.padding - Es(t.title, this.chart.options.font), r = Math.sqrt(c * c + d * d), l = It(Math.min(Math.asin(Ht((h.highest.height + 6) / o, -1, 1)), Math.asin(Ht(a / r, -1, 1)) - Math.asin(Ht(d / r, -1, 1)))), l = Math.max(s, Math.min(n, l))),
                    ...
                    if (h = t[a].label, c = this._resolveTickFontOptions(a), i.font = d = c.string, u = s[d] = s[d] || {
                        ...
                        if (Y(h))
                            for (r = 0, l = h.length; r < l; ++r)
                                m = h[r], $(m) || Y(m) || (g = Ut(i, u.data, u.gc, g, m), p += f)
                    } else
                        g = Ut(i, u.data, u.gc, g, h), p = f;
                    n.push(g),
                    o.push(p),
                    x = Math.max(g, x),
                    b = Math.max(p, b)
            ...
            _computeGridLineItems(t) {
                ...
                for (m = 0; m < l; m += C) {
                    ...
                    x = Ls(this, m, a),
                    void 0 !== x && (b = qt(i, x, e), r ? _ = v = M = S = b : y = w = k = P = b, c.push({
                            tx1: _,
                            ty1: y,
                            tx2: v,
                            ty2: w,
            ...
            drawBorder() {
                ...
                h,
                c;
                this.isHorizontal() ? (r = qt(t, this.left, n) - n / 2, l = qt(t, this.right, o) + o / 2, h = c = a) : (h = qt(t, this.top, n) - n / 2, c = qt(t, this.bottom, o) + o / 2, r = l = a),
                e.save(),
        ...
        function qs(t, e) {
            let i = Us.get(t);
            return i || (i = e(), Us.set(t, i), Xs.add(i)),
            i
        }
        const Ks = (t, e, i) => {
            const s = lt(e, i);
        ...
        class hn {
            constructor(t, e) {
                ...
                this._dataChanges = [],
                an[this.id] = this,
                l && h ? (a.listen(this, "complete", sn), a.listen(this, "progress", nn), this._initialize(), this.attached && this.update()) : console.error("Failed to create chart: can't acquire context from the given item")
            }
            get aspectRatio() {
                const {
                    options: {
            ...
            buildOrUpdateControllers() {
                ...
                for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                    ...
                    if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || Hs(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller)
            ...
            _handleEvent(t, e) {
                ...
                Zt(t, this.chartArea, this._minPadding) && (Q(s.onHover, [t, a, this], this), "mouseup" !== t.type && "click" !== t.type && "contextmenu" !== t.type || Q(s.onClick, [t, a, this], this)),
                r = !tt(a, i),
        ...
        function yn(t, e, i, s) {
            ...
            o,
            a;
            return s ? (a = i, t = vn(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = vn(t, e, i),
            t
        }
        function vn(t, e, i) {
        ...
        function zn(t, e, i, s, n) {
            ...
            o.borderWidth && (a ? (t.lineWidth = 2 * o.borderWidth, t.lineJoin = "round") : (t.lineWidth = o.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function (t, e, i) {
                ...
                h = e.innerRadius + a;
                let c;
                for (i && Ln(t, e, o + _t), t.beginPath(), t.arc(s, n, h, o + _t, o, !0), c = 0; c < r; ++c)
                    t.stroke();
        ...
        function Yn(t, e, i, s) {
            ...
            (t, e, i, s) : function (t, e, i, s) {
                ...
                a = jn(e);
                for (const r of n)
                    Bn(t, o, r.style), t.beginPath(), a(t, e, r, {
                        start: i,
                        end: i + s - 1
        ...
        class Un extends Ss {
            ...
            draw(t, e, i, s) {
                ...
                (this.points || []).length && n.borderWidth && (t.save(), Yn(t, this, i, s), t.restore()),
        ...
        function lo(t) {
            return (t.scale || {}).getPointPositionForValue ? function (t) {
                ...
                if (c = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue(), s.grid.circular)
                    return h = e.getPointPositionForValue(0, a), new ro({
                        x: h.x,
                        y: h.y,
        ...
        var Mo = {
            ...
            afterDatasetsUpdate(t, e, i) {
                ...
                l;
                for (a = 0; a < s; ++a)
                    o = t.getDatasetMeta(a), r = o.dataset, l = null, r && r.options && r instanceof Un && (l = {
            ...
            _getLegendItemAt(t, e) {
                ...
                if ($t(t, this.left, this.right) && $t(e, this.top, this.bottom))
                    for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
                        if (s = n[i], $t(t, s.left, s.left + s.width) && $t(e, s.top, s.top + s.height))
        ...
        class Ho extends Ss {
            ...
            drawTitle(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = Vo(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = We(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r)
            ...
            drawFooter(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = Vo(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = We(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a)
        ...
        class qo extends zs {
            ...
            buildTicks() {
                ...
                const s = function (t, e) {
                    ...
                    for (m && (d && v !== o ? (i.push({
                                    value: o
                                }), v < o && P++, Tt(Math.round((v + P * k) * y) / y, o, Xo(o, _, t)) && P++) : v < o && P++); P < M; ++P)
                        i.push({
